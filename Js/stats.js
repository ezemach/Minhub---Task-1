...
function traerEventos (){
    ...
    .then( datos =>{ filtrarLista(datos.events, datos)
        completarTarjetas(eventoMayorA(datos.events,datos) , eventoMenorA(datos.events,datos) , resultadoMasCapacidad(datos.events), Eventos1);
        const categories = {}
...
const temple = () => {
        ...
        EventosPast.innerHTML=templeDos
...
const temple = () => {
        ...
        EventosFut.innerHTML=templeTres
